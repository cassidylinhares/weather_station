...
class weather_database:
    def __init__(self):
        ...
        self.insert_template = "INSERT INTO WEATHER_MEASUREMENT (AIR_TEMPERATURE, PRESSURE, HUMIDITY, CREATED_ON) VALUES(%s, %s, %s, %s);"
    ...
    def insert(self, ambient_temperature, air_pressure, humidity, created = datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")):
